...
export function ffs_construct_query(
  ...
  const configuration = new Configuration({
    apiKey: "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"
  });
  ...
  openai
    .createCompletion({
      ...
      prompt: `// JavaScript\n// What is the Overpass API request to find ${search} ?\n`,
      temperature: 0.7,
      max_tokens: 256,
      top_p: 1,
      frequency_penalty: 0,
    ...
    .then((completion) => {
      callback(null, completion.data.choices[0].text);
    })
    .catch((e) => {
      console.error(e);
      callback("OpenAI error");
    });
